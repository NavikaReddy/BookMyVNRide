<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BookMyVNRide_DBMS.Login" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:TextBox runat="server" ID="txt_Username" placeholder="Enter email id"></asp:TextBox>
